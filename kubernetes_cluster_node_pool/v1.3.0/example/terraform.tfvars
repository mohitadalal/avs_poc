...
resource_group_variables = {
  "resource_group_1" = {
    resource_group_name     = "ploceusrg00001" #(Required) Name of the Resource Group with which it should be created.
...
user_assigned_identity_variables = {
  "user_assigned_identity_1" = {
    ...
    user_assigned_identity_resource_group_name = "ploceusrg00001"   #Required) Specifies the name of the Resource Group within which this User Assigned Identity should exist. Changing this forces a new User Assigned Identity to be created.
...
virtual_network_variables = {
  "virtual_network_1" = {
    ...
    virtual_network_resource_group_name     = "ploceusrg00001"            #(Required) The name of the resource group in which to create the virtual network.
...
subnet_variables = {
  "subnet_1" = {
    ...
    subnet_resource_group_name                            = "ploceusrg00001"      #(Required) The name of the resource group in which to create the subnet. Changing this forces a new resource to be created.
    subnet_address_prefixes                               = ["10.30.0.0/24"]      #(Required) The address prefixes to use for the subnet.
...
role_assignment_variables = {
  "role_assignment_1" = {
    ...
    role_assignment_target_resource_name                   = "xxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"                                                             # (Required) The name of the resource to which we are assigning role
...
key_vault_variables = {
  "key_vault_1" = {
    ...
    key_vault_resource_group_name                   = "ploceusrg00001"                                                                                                                                                                                #(Required) The name of the resource group in which to create the Key Vault.
...
key_vault_access_policy_variables = {
  "key_vault_access_policy_1" = {
    ...
    key_vault_resource_group_name                   = "ploceusrg00001"                                                                                                                                                                                #(Required) Specifies the resource group name where the key vault resides in.
    key_vault_access_resource_name                  = "xxxxxxxx@plocues.com"                                                                                                                                                                          #(Required) Specifies the resource name that needs an access policy to the key vault. Possible values are username, group name, service principal name and application name
...
key_vault_key_variables = {
  "key_vault_key_1" = {
    key_vault_name                = "ploceuskv000001"                                                #(Required) The name of the Key Vault where the Key should be created.
    key_vault_resource_group_name = "ploceusrg00001"                                                 #(Required) The resource group name of the Key Vault where the Key should be created.
...
key_vault_secret_variables = {
  "key_vault_secret_1" = {
    ...
    key_vault_secret_resource_group_name = "ploceusrg00001"              #(Required) Specifies the name of the resource group, where the key_vault resides in
...
kubernetes_cluster_variables = {
  "kubernetes_cluster_1" = {
    ...
    kubernetes_cluster_resource_group_name                                             = "ploceusrg00001"   # (Required) Specifies the Resource Group where the Managed Kubernetes Cluster should exist. Changing this forces a new resource to be created.
    kubernetes_cluster_key_vault_name                                                  = "ploceuskv000001"  #(Optional) Incase if any secret value is passed for linux_profile, windows_profile, azure_active_directory_role_based_access_control(azure_active_directory_role_based_access_control_server_app_secret) or service_principal(client_secret). Pass null if not required
    kubernetes_cluster_key_vault_resource_group_name                                   = "ploceusrg00001"   #(Optional) To be provided for the kubernetes_cluster_key_vault_name  resource group
    ...
    kubernetes_cluster_default_node_pool_vm_size                                       = "Standard_D8ds_v5" #(Required) The size of the Virtual Machine, such as Standard_DS2_v2. Changing this forces a new resource to be created.
    ...
    kubernetes_cluster_default_node_pool_virtual_network_resource_group_name = "ploceusrg00001"
    ...
    kubernetes_cluster_identity = {  #One of either identity or service_principal must be specified. Assign null if not required. Defines the kubernetes cluster identity to be used
      ...
      identity_resource_group_name = "ploceusrg00001" }]
    }
    ...
    #   ingress_application_gateway_resource_group_name        = "ploceusrg00001"
    ...
    kubernetes_cluster_linux_profile = {                                  #(Optional) Pass as null if not required. Changing any parameter forces a new resource to be created.
    ...
    #   web_app_routing_dns_zone_resource_group = "ploceusrg00001"             #(Required) Specifies the ID of the DNS Zone in which DNS entries are created for applications deployed to the cluster when Web App Routing is enabled.
    # }
    kubernetes_cluster_windows_profile = null
  }
}
...
kubernetes_cluster_node_pool_variables = {
  "kubernetes_cluster_node_pool_1" = {
    kubernetes_cluster_node_pool_kubernetes_cluster_name                        = "ploceusaks000001"    #(Required) The name of the Kubernetes Cluster where this Node Pool should exist. Changing this forces a new resource to be created.
    kubernetes_cluster_node_pool_kubernetes_cluster_resource_group_name         = "ploceusrg00001"      #(Required) The resource group of the Kubernetes Cluster where this Node Pool should exist. Changing this forces a new resource to be created.
    ...
    kubernetes_cluster_node_pool_subnet_name                                    = "ploceussubnet000001" #(Optional) The name of the Subnet where this Node Pool should exist. At this time the kubernetes_cluster_node_pool_subnet_name must be the same for all node pools in the cluster
    kubernetes_cluster_node_pool_virtual_network_name                           = "ploceusvnet000001"   #(Optional) The name of the Vnet where kubernetes_cluster_node_pool_subnet_name exists.
    kubernetes_cluster_node_pool_virtual_network_resource_group_name            = "ploceusrg00001"      #(Optional) Resource group name of the Node pool subnet
    ...
    kubernetes_cluster_node_pool_name                                           = "pool000001"          #(Required) The name of the Node Pool which should be created within the Kubernetes Cluster. A Windows Node Pool cannot have a name longer than 6 characters. 
    kubernetes_cluster_node_pool_vm_size                                        = "Standard_d4pds_v5"   #(Required) The SKU which should be used for the Virtual Machines used in this Node Pool. Changing this forces a new resource to be created.
    kubernetes_cluster_custom_ca_trust_enabled                                  = false                 #(Optional) Specifies whether to trust a Custom CA.
    kubernetes_cluster_node_pool_enable_auto_scaling                            = false                 #(Optional) Whether to enable auto-scaler. Defaults to false. If kubernetes_cluster_node_pool_enable_auto_scaling is set to true, then the following fields can also be configured:kubernetes_cluster_node_pool_max_count, kubernetes_cluster_node_pool_min_count. 2)If kubernetes_cluster_node_pool_enable_auto_scaling is set to false, then the following fields can also be configured:kubernetes_cluster_node_pool_node_count.
    ...
    kubernetes_cluster_node_pool_enable_node_public_ip                          = false                 #(Optional) Should each node have a Public IP Address? Defaults to false. Changing this forces a new resource to be created.
    ...
    kubernetes_cluster_node_pool_orchestrator_version                           = "1.27.3"              #(Optional) Version of Kubernetes used for the Agents. If not specified, the latest recommended version will be used at provisioning time (but won't auto-upgrade). This version must be supported by the Kubernetes Cluster - as such the version of Kubernetes used on the Cluster/Control Plane may need to be upgraded first.
    ...
    kubernetes_cluster_node_pool_os_sku                                         = "Ubuntu"              #(Optional) Specifies the OS SKU used by the agent pool. Possible values include: AzureLinux, Ubuntu, Windows2019, Windows2022. If not specified, the default is Ubuntu if OSType=Linux or Windows2019 if OSType=Windows. And the default Windows OSSKU will be changed to Windows2022 after Windows2019 is deprecated. Changing this forces a new resource to be created.
    kubernetes_cluster_node_pool_os_type                                        = "Linux"               #(Optional) The Operating System which should be used for this Node Pool. Changing this forces a new resource to be created. Possible values are Linux and Windows. Defaults to Linux.
    ...
    kubernetes_cluster_node_pool_ultra_ssd_enabled                              = false                 #(Optional) Used to specify whether the UltraSSD is enabled in the Node Pool. Defaults to false
    kubernetes_cluster_node_pool_workload_runtime                               = null                  #(Optional) Used to specify the workload runtime. Allowed values are OCIContainer and WasmWasi.
    ...
    kubernetes_cluster_node_pool_max_count = null #(Required)If enable_auto_scaling is set to true. (Required) The maximum number of nodes which should exist within this Node Pool. Valid values are between 0 and 1000 and must be greater than or equal to min_count.
    kubernetes_cluster_node_pool_min_count = null #(Required) The minimum number of nodes which should exist within this Node Pool. Valid values are between 0 and 1000 and must be less than or equal to max_count.
    ...
    # }
    kubernetes_cluster_node_pool_windows_profile = null #(Optional) A windows_profile block as documented below. Changing this forces a new resource to be created.
    #   {
